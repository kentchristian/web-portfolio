  ...
  return (
    <>
      ...
      <div className="grid grid-cols-[1.5fr_3fr]">
        {/* button */}
        <section className="flex flex-col border-r-0 border rounded-sm items-center justify-center overflow-auto themed-scrollbar">
        ...
        {/* Content */}
        <article className="p-5 border rounded-sm overflow-auto themed-scrollbar max-h-70">
