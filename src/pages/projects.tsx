              ...
              <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                {highlightedProjects.map((project) => {
                  ...
                  return (
                    <article
                      key={project.key}
                      className="group flex h-full flex-col rounded-2xl border border-border/70 bg-background/70 p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
                    >
                      ...
                      {isLockedProject ? (
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          {project.pinnedLinks.map((link) => (
                            <Badge key={link.url} variant="outline">
                              {link.label}
                            </Badge>
                          ))}
                        </div>
                      ...
                      {isLockedProject ? (
                        ...
                        <div className="mt-5 flex flex-col gap-2">
                          ...
                          {secondaryPinnedLinks.map((link) => (
                            <Button key={link.url} asChild size="sm" variant="outline" className="w-full">
